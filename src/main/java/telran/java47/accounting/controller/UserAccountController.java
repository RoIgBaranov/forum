...
public class UserAccountController{
	...
	@PutMapping("/password")
	public void chagePassword(Principal principal, @RequestHeader("X-Password") String newPassword) {
		userAccountService.chagePassword(principal.getName(), newPassword);
